...
// Source: github.com/kubernetes-csi/external-snapshot-metadata/pkg/api (interfaces: SnapshotMetadataClient,SnapshotMetadata_GetMetadataAllocatedClient,SnapshotMetadata_GetMetadataDeltaClient)
...
func (m *MockSnapshotMetadataClient) GetMetadataAllocated(arg0 context.Context, arg1 *api.GetMetadataAllocatedRequest, arg2 ...grpc.CallOption) (api.SnapshotMetadata_GetMetadataAllocatedClient, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(api.SnapshotMetadata_GetMetadataAllocatedClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSnapshotMetadataClient) GetMetadataDelta(arg0 context.Context, arg1 *api.GetMetadataDeltaRequest, arg2 ...grpc.CallOption) (api.SnapshotMetadata_GetMetadataDeltaClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(api.SnapshotMetadata_GetMetadataDeltaClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSnapshotMetadata_GetMetadataAllocatedClient) Recv() (*api.GetMetadataAllocatedResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*api.GetMetadataAllocatedResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Recv mocks base method.
func (m *MockSnapshotMetadata_GetMetadataDeltaClient) Recv() (*api.GetMetadataDeltaResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*api.GetMetadataDeltaResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
