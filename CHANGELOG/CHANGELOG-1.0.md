...
- `SnapshotMetadataService` is now available in v1beta1 version. The support for the v1alpha1 version have been removed. ([#215](https://github.com/kubernetes-csi/external-snapshot-metadata/pull/215), [@PrasadG193](https://github.com/PrasadG193))
...
- The snapshot-metadata-lister and snapshot-metadata-verifier tools can now be installed directly using `go install`:
  ...
  Previously, installation failed due to `replace` directives in the main module's go.mod. ([#202](https://github.com/kubernetes-csi/external-snapshot-metadata/pull/202), [@iPraveenParihar](https://github.com/iPraveenParihar))

### Uncategorized

- Bump dependencies to kubernetes v1.35 ([#199](https://github.com/kubernetes-csi/external-snapshot-metadata/pull/199), [@rhrmo](https://github.com/rhrmo))
- Health checks now use HTTP endpoint (/health on port 8080) instead of grpc_health_probe binary ([#190](https://github.com/kubernetes-csi/external-snapshot-metadata/pull/190), [@kaovilai](https://github.com/kaovilai))
- Update Go version to 1.26.1 ([#221](https://github.com/kubernetes-csi/external-snapshot-metadata/pull/221), [@PrasadG193](https://github.com/PrasadG193))
- Downgrade Go version to 1.25.8 to fix image push CI. ([#226](https://github.com/kubernetes-csi/external-snapshot-metadata/pull/226), [@PrasadG193](https://github.com/PrasadG193))
...
- github.com/go-openapi/swag/cmdutils: [v0.25.5](https://github.com/go-openapi/swag/tree/cmdutils/v0.25.5)
- github.com/go-openapi/swag/conv: [v0.25.5](https://github.com/go-openapi/swag/tree/conv/v0.25.5)
- github.com/go-openapi/swag/fileutils: [v0.25.5](https://github.com/go-openapi/swag/tree/fileutils/v0.25.5)
- github.com/go-openapi/swag/jsonname: [v0.25.5](https://github.com/go-openapi/swag/tree/jsonname/v0.25.5)
...
- github.com/go-openapi/swag/jsonutils: [v0.25.5](https://github.com/go-openapi/swag/tree/jsonutils/v0.25.5)
- github.com/go-openapi/swag/loading: [v0.25.5](https://github.com/go-openapi/swag/tree/loading/v0.25.5)
- github.com/go-openapi/swag/mangling: [v0.25.5](https://github.com/go-openapi/swag/tree/mangling/v0.25.5)
- github.com/go-openapi/swag/netutils: [v0.25.5](https://github.com/go-openapi/swag/tree/netutils/v0.25.5)
- github.com/go-openapi/swag/stringutils: [v0.25.5](https://github.com/go-openapi/swag/tree/stringutils/v0.25.5)
- github.com/go-openapi/swag/typeutils: [v0.25.5](https://github.com/go-openapi/swag/tree/typeutils/v0.25.5)
- github.com/go-openapi/swag/yamlutils: [v0.25.5](https://github.com/go-openapi/swag/tree/yamlutils/v0.25.5)
- github.com/go-openapi/testify/enable/yaml/v2: [v2.4.0](https://github.com/go-openapi/testify/tree/enable/yaml/v2/v2.4.0)
- github.com/go-openapi/testify/v2: [v2.4.0](https://github.com/go-openapi/testify/tree/v2.4.0)
...
- github.com/go-openapi/jsonpointer: [v0.21.1 → v0.22.5](https://github.com/go-openapi/jsonpointer/compare/v0.21.1...v0.22.5)
- github.com/go-openapi/jsonreference: [v0.21.0 → v0.21.5](https://github.com/go-openapi/jsonreference/compare/v0.21.0...v0.21.5)
- github.com/go-openapi/swag: [v0.23.1 → v0.25.5](https://github.com/go-openapi/swag/compare/v0.23.1...v0.25.5)
...
- github.com/kubernetes-csi/external-snapshotter/v8: [v8.4.0 → v8.5.0](https://github.com/kubernetes-csi/external-snapshotter/compare/v8.4.0...v8.5.0)
...
- go.opentelemetry.io/otel/sdk/metric: v1.34.0 → v1.42.0
- go.opentelemetry.io/otel/sdk: v1.34.0 → v1.42.0
...
- golang.org/x/crypto: v0.37.0 → v0.48.0
- golang.org/x/exp: 8a7402a → 716be56
- golang.org/x/mod: v0.20.0 → v0.32.0
...
- golang.org/x/term: v0.31.0 → v0.40.0
- golang.org/x/text: v0.24.0 → v0.34.0
...
- google.golang.org/genproto/googleapis/rpc: a0af3ef → a57be14
